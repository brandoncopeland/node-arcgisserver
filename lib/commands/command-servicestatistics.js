...
var writeReport = function (report) {
  ...
  console.log('---');
  console.log(consoleTheme.info('Folders: %d'), report.folderCount);
  console.log(consoleTheme.info('Services: %d'), report.serviceCount);
  console.log(consoleTheme.info('Public Services: %d'), report.publicCount);
  console.log(consoleTheme.info('Cached Map Services: %d'), report.cachedCount);
  console.log('---');
  console.log('Service Types');
  _.each(report.typeCount, function (value, key) {
    console.log(consoleTheme.info('%s: %s'), key, value);
  });
  console.log('---');
  console.log('Statuses');
  _.each(report.statusCount, function (value, key) {
    console.log(consoleTheme.info('%s: %s'), titleCase(key.toLowerCase()), value); // returned from server as all caps. make title.
  });
  console.log('---');
  console.log('Instances');
  console.log(consoleTheme.info('Maximum Possible Instances: %d'), report.maxInstanceCount);
  console.log(consoleTheme.info('Current Instances Busy: %d'), report.busyInstanceCount);
  console.log(consoleTheme.info('Current Instances Free: %d'), report.freeInstanceCount);
};
